...
# Root directory holding all user application settings and data. Not user-editable yet.
USER_DATA_ROOT = "~/.qaa-tms"
QAA_TMS_HOME_ENV = "QAA_TMS_HOME"
QAA_TMS_AGENT_SERVICE_MANAGED_ENV = "QAA_TMS_AGENT_SERVICE_MANAGED"
NOTEBOOK_DIR_NAME = "notebook"
REQUESTS_DIR_NAME = "requests"
REQUESTS_COLLECTIONS_DIR_NAME = "collections"
REQUESTS_CREDENTIALS_FILE_NAME = "credentials.json"
REQUESTS_ENVIRONMENTS_FILE_NAME = "environments.json"
REQUESTS_HISTORY_FILE_NAME = "history.jsonl"
LOGS_DIR_NAME = "logs"
DEFAULT_AUTH_CACHE_TTL_SECONDS = 30
REQUESTS_HISTORY_LIMIT = 500
DEFAULT_REQUESTS_TIMEOUT_SECONDS = 60.0
DEFAULT_REQUESTS_TOKEN_TTL_SECONDS = 300
REQUESTS_TOKEN_EXPIRY_SKEW_SECONDS = 30
REDACTED_VALUE = "***"
...
DEFAULT_MANAGED_KUBECONFIG_DIR = "~/.kube"
...
NOTEBOOK_BACKUP_DIR_SUFFIX = "-backups"
NOTEBOOK_BACKUP_FILE_PREFIX = "qaa-notebook-"
REQUESTS_BACKUP_FILE_PREFIX = "qaa-requests-"
NOTEBOOK_BACKUP_NAME_FORMAT = "%Y-%m-%d-%H%M%S"
