...
class ServerSettingsRead(BaseModel):
    ...
    qaa_generator_actor: str
    qaa_generator_service_token_set: bool
...
class ServerSettingsUpdateRequest(BaseModel):
    ...
    qaa_generator_actor: str | None = None
    qaa_generator_service_token: str | None = None
...
def to_server_settings_read(settings: Settings) -> ServerSettingsRead:
    return ServerSettingsRead(
        ...
        qaa_generator_actor=settings.qaa_generator_actor,
        qaa_generator_service_token_set=bool(settings.qaa_generator_service_token),
