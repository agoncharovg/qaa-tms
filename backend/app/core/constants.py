...
class EnvKey(StrEnum):
    ...
    QAA_GENERATOR_PORT_FORWARD_ENABLED = "QAA_GENERATOR_PORT_FORWARD_ENABLED"
    QAA_GENERATOR_PORT_FORWARD_NAMESPACE = "QAA_GENERATOR_PORT_FORWARD_NAMESPACE"
    QAA_GENERATOR_PORT_FORWARD_RESOURCE = "QAA_GENERATOR_PORT_FORWARD_RESOURCE"
    QAA_GENERATOR_PORT_FORWARD_LOCAL_PORT = "QAA_GENERATOR_PORT_FORWARD_LOCAL_PORT"
    QAA_GENERATOR_PORT_FORWARD_REMOTE_PORT = "QAA_GENERATOR_PORT_FORWARD_REMOTE_PORT"
...
DEFAULT_QAA_GENERATOR_PORT_FORWARD_ENABLED = False
DEFAULT_QAA_GENERATOR_PORT_FORWARD_NAMESPACE = "qaa-prod"
